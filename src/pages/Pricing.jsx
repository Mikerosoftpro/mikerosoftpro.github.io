    ...
    <div className="flex flex-wrap lg:flex-nowrap justify-center ">
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center">
        <div className="flex justify-between items-center">
          <div>
            <p className="font-bold text-gray-400">Bids Due</p>
    ...
    <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
            <div className="flex justify-between">
               <p className='font-semibold text-xl'>Pricing Update</p>
            ...
            <div className='mt-10 flex-10 flex-wrap justify-center'>
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Team Overview</p>
          ...
          <div className="mt-2">
            <p className="text-md font-semibold mb-2">Members</p>
            <div className="flex gap-4">
          ...
          <div className="flex justify-between items-center mt-5 border-t-1 border-color">
            ...
            <p className="text-gray-400 text-sm">52 bids completed ths month</p>
          </div>
        </div>
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">News Feed</p>
            <button type="button" className="text-xl font-semibold text-gray-500">
              <IoIosMore />
            </button>
          </div>
          <div className="mt-10">
            ...
            />
            <div className="mt-8">
              <p className="font-semibold text-lg">Higher Transport Rates on the Horizon</p>
              <p className="text-gray-400 ">By Inbound Logistics</p>
